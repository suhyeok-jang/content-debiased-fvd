...
def main(args):
    ...
    outfile = os.path.join('/home/jsh/content-debiased-fvd/stats/new/fvd_128/UCF-101', 'fvd_256to224.tsv')
    ...
    with open(outfile, 'a') as f:
        ...
        for generation_type in ['videocrafter_fifo']:
            evaluator.load_fake_stats(args.real_stat_path.replace('real_1', generation_type).replace('_x3',''))
