...
def main(args):    
    ...
    evaluator = fvd_copy.cdfvd('videomae', n_real = args.num_clip_samples, n_fake = args.num_clip_samples, seed=args.seed, compute_feats =False, device = "cuda", half_precision = True)
    ...
    if args.video_type in ('real_1', 'real_2'):
        ...
        evaluator.compute_real_stats(real_video_loader, concat = args.fvd_16, make_gif=True) #evaluator FeatureStats에 저장
        ...
        evaluator.compute_fake_stats(fake_video_loader, concat = args.fvd_16, make_gif=True) 
